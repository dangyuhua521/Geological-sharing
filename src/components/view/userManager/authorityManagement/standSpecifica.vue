<template>
    <div :class="$style.subMains">
                    ...
                    >
                        ...
                        >
                            <el-radio
                                v-model="editTree.id"
                                :disabeld="true"
                                :label="data.id" style="margin-right: 0px;"
                                >&nbsp;</el-radio
                            >
                            <span>{{ data.name }}</span>
            ...
            >
                ...
                >
                    <el-upload
                        ...
                        class="upload-demo"
                        :headers="fileData"
                        :action="api + '/TYwPolicylaw/upload'"
        ...
        >
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="dialogTreeFormVisible = false"
                    >取 消</el-button
                >
    ...
    methods: {
        ...
        editTreeData(type) {
            ...
            if (type == 'edit') {
                ...
                this.$confirm(
                    ...
                    _this.$axios
                        .post('/TYwPolicylawtype/DeleteDataList', _data)
                        .then(res => {
                            _this.$notify({
                                message: '删除成功',
                                type: 'success',
        ...
        saveTree() {
            ...
            this.$confirm('是否提交?', '提示', {
                ...
                _this.$axios
                    .post('/TYwPolicylawtype/SaveDataList', _data)
                    .then(res => {
                        _this.$notify({
                            type: 'success',
                            message: '保存成功',
        ...
        uploadNew() {
            ...
            this.$confirm('是否提交?', '提示', {
                ...
                _this.$axios
                    .post('/TYwPolicylaw/SaveDataList', _data)
                    .then(res => {
                        _this.$notify({
                            type: 'success',
                            message: '保存成功',
